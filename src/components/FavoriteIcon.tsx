...
import {useToggleFavoriteContext} from "./UseToggleFavoriteContext.tsx"; // adjust the path accordingly
...
export function FavoriteIcon({pokemonDetails}: FavoriteIconProps) {
  const {toggleFavorite , isFavorite } = useToggleFavoriteContext(pokemonDetails);
  return (
    <button
      type="button"
